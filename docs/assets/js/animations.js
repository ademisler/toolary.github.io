...
const ICON_DEFINITIONS = {
  ...
  link: {
    ...
    elements: [
      ...
      { tag: 'path', attrs: { d: 'M15 7h2a5 5 0 0 1 0 10h-2' } },
...
// Tool data - matches extension's tools-manifest.json
const toolsData = [
  {
    id: 'color-picker',
    name: 'Color Picker',
    category: 'inspect',
    icon: 'color',
    description: 'Extract colors from any element on the page',
    features: ['Click to pick colors', 'Copy to clipboard', 'Color history', 'RGB/HEX/HSL formats']
  },
  {
    id: 'element-picker',
    name: 'Element Picker',
    ...
    features: ['Click to select elements', 'View CSS properties', 'Element hierarchy', 'Copy selectors']
  },
  {
    id: 'font-picker',
    name: 'Font Picker',
    category: 'inspect',
    icon: 'font',
    description: 'Analyze typography and font properties',
    features: ['Font family detection', 'Size and weight analysis', 'Font loading status', 'Web font detection']
  },
  {
    id: 'link-picker',
    name: 'Link Picker',
    category: 'inspect',
    icon: 'link',
    description: 'Validate and analyze links on the page',
    features: ['Link validation', 'Status code checking', 'Broken link detection', 'Link analysis']
  },
  {
    ...
    category: 'capture',
    icon: 'screenshot',
    description: 'Capture screenshots of page elements',
    features: ['Element screenshots', 'Full page capture', 'Custom area selection', 'High quality output']
  },
  {
    id: 'media-picker',
    name: 'Media Picker',
    category: 'capture',
    icon: 'image',
    description: 'Extract images and media from the page',
    features: ['Image extraction', 'Media file detection', 'Bulk download', 'Format conversion']
  },
  {
    id: 'text-picker',
    name: 'Text Picker',
    category: 'capture',
    icon: 'text',
    description: 'Extract and copy text content',
    features: ['Text selection', 'Bulk text extraction', 'Copy to clipboard', 'Text formatting']
  },
  {
    id: 'pdf-generator',
    name: 'PDF Generator',
    ...
    features: ['Page to PDF', 'Custom page size', 'Print optimization', 'Download ready']
  },
  {
    ...
    features: ['URL QR codes', 'Text QR codes', 'Custom styling', 'Download options']
  },
  {
    id: 'video-recorder',
    name: 'Video Recorder',
    category: 'capture',
    icon: 'video',
    description: 'Record screen activity and interactions',
    features: ['Screen recording', 'Audio capture', 'Custom duration', 'Export options']
  },
  {
    ...
    features: ['Persistent notes', 'Custom positioning', 'Color coding', 'Export notes']
  },
  {
    id: 'text-highlighter',
    ...
    category: 'enhance',
    icon: 'highlighter',
    description: 'Highlight important text on pages',
    features: ['Text highlighting', 'Multiple colors', 'Persistent highlights', 'Export highlights']
  },
  {
    id: 'reading-mode',
    name: 'Reading Mode',
    ...
    features: ['Clean reading view', 'Customizable fonts', 'Focus mode', 'Print optimization']
  },
  {
    id: 'bookmark-manager',
    ...
    features: ['Smart bookmarks', 'Category organization', 'Search functionality', 'Import/Export']
  },
  {
    id: 'dark-mode-toggle',
    ...
    features: ['One-click toggle', 'Persistent setting', 'Smart detection', 'Custom themes']
  },
  {
    id: 'site-info-picker',
    name: 'Site Info Picker',
    category: 'utilities',
    icon: 'site',
    description: 'Analyze website information and performance',
    features: ['Site analysis', 'Performance metrics', 'Technology detection', 'SEO insights']
  },
  {
    ...
    features: ['Auto palette generation', 'Color harmony', 'Export options', 'Design integration']
  },
  {
    ...
    features: ['Clipboard history', 'Search functionality', 'Category organization', 'Quick access']
  },
  {
    id: 'text-summarizer',
    ...
    features: ['Smart summarization', 'Multiple lengths', 'Key point extraction', 'Language support']
  },
  {
    id: 'text-translator',
    ...
    features: ['Multi-language support', 'Context awareness', 'Bulk translation', 'Quality detection']
  },
  {
    id: 'content-detector',
    ...
    features: ['AI detection', 'Confidence scoring', 'Content analysis', 'Detailed reports']
  },
  {
    id: 'email-generator',
    ...
    features: ['Smart templates', 'Tone adjustment', 'Context awareness', 'Multiple formats']
  },
  {
    id: 'seo-analyzer',
    name: 'SEO Analyzer',
    ...
    features: ['Comprehensive analysis', 'Keyword optimization', 'Content suggestions', 'Performance insights']
  },
  {
    id: 'ai-chat',
    name: 'AI Chat',
    ...
    features: ['Contextual responses', 'Multi-language support', 'Smart suggestions', 'Conversation history']
  }
];

// Coffee messages for tools (English only for website)
const coffeeMessages = {
  'color-picker': "I drank three coffees and had two minor breakdowns to find this color. A refill would boost morale!",
  'element-picker': "After dealing with this many CSS selectors, I don't need coffee—I need espresso in an IV drip!",
  'link-picker': "Error 404: Coffee not found. Would you like to fix that?",
  'font-picker': "Four cigarettes and one empty mug later, the typography war is won!",
  'media-picker': "While fetching all these media files, it wasn't my RAM that ran out—it was my coffee.",
  'text-picker': "Extracted the text, but the meaning stayed behind. Maybe coffee could've helped me find it.",
  'screenshot-picker': "While taking the screenshot, it wasn't the mouse that shook—it was my hand, from lack of coffee.",
  'pdf-generator': "My coffee ran out while generating this PDF—so forgive the slightly grumpy corners.",
  'qr-code-generator': "Every pixel in this QR code contains a trace of caffeine and despair.",
  'video-recorder': "Video recording complete—but I accidentally focused on my coffee instead of the screen.",
  'sticky-notes-picker': "Maybe add another one that says 'Buy coffee,' just in case.",
  'reading-mode': "Reading mode: ON. Social life: OFF. Coffee: EMPTY.",
  'text-highlighter': "Highlight done. Dark circles included for free.",
  'bookmark-manager': "Added to favorites. Wish coffee could be bookmarked too.",
  'dark-mode-toggle': "Even in dark mode, coffee still shines bright.",
  'site-info-picker': "Collected all site info. Only thing missing? The coffee menu.",
  'color-palette-generator': "I spilled my coffee on the color palette. That's why it looks so warm.",
  'copy-history-manager': "I tracked every copy—but missed my coffee break doing it.",
  'text-summarizer': "Even AI doesn't work without coffee. Believe me, I've tested it.",
  'text-translator': "Translation done! 'Would you like a coffee?' works in every language.",
  'content-detector': "AI or human, whoever wrote it deserves a coffee.",
  'email-generator': "Email ready! But a coffee-fueled 'hello' always feels more genuine.",
  'seo-analyzer': "SEO report done. I'm shocked I managed this without coffee.",
  'ai-chat': "After this chat, I even asked my coffee how it's doing."
};
...
function createIconElement(iconName) {
  ...
  iconDef.elements.forEach(element => {
    const el = document.createElementNS('http://www.w3.org/2000/svg', element.tag);
...
// Coffee toast system
function showCoffeeMessage(toolId) {
  const message = coffeeMessages[toolId];
  if (!message) return;

  const toast = document.getElementById('coffee-toast');
  const messageEl = document.getElementById('coffee-toast-message');
...
// DOM elements
let toolsGrid, searchInput, categoryMenu, categoryMenuBtn, toolModal, toolModalTitle, toolModalCategory, toolModalDescription, toolModalFeatures, toolModalClose, toolModalCloseBtn;
...
function initializeElements() {
  ...
  toolModalCategory = document.getElementById('tool-modal-category');
  toolModalDescription = document.getElementById('tool-modal-description');
  toolModalFeatures = document.getElementById('tool-modal-features');
  toolModalClose = document.getElementById('tool-modal-close');
  toolModalCloseBtn = document.getElementById('tool-modal-close-btn');
}
...
function setupEventListeners() {
  ...
  document.addEventListener('keydown', function(e) {
    if (e.key === 'Escape' && toolModal && toolModal.classList.contains('show')) {
      closeToolModal();
    }
  });
  ...
  document.addEventListener('click', function(e) {
    if (categoryMenu && !categoryMenu.contains(e.target) && !categoryMenuBtn.contains(e.target)) {
...
function handleCategorySelect(e) {
  const button = e.target.closest('.category-menu-item');
  if (!button) return;
  ...
  categoryMenuBtn.querySelector('span').textContent = categoryText;
...
function createToolCard(tool) {
  ...
  const icon = createIconElement(tool.icon);
...
function showToolModal(tool) {
  ...
  if (toolModalTitle) toolModalTitle.textContent = tool.name;
  if (toolModalCategory) toolModalCategory.textContent = tool.category;
  if (toolModalDescription) toolModalDescription.textContent = tool.description;

  // Update features list
  if (toolModalFeatures) {
  ...
  // Update modal icon
  const modalIcon = toolModal.querySelector('.tool-modal-icon');
  if (modalIcon) {
    modalIcon.innerHTML = '';
    const icon = createIconElement(tool.icon);
...
function updateSearchFeedback() {
  ...
  if (searchResultCount) {
    searchResultCount.textContent = `${filteredTools.length} tool${filteredTools.length !== 1 ? 's' : ''}`;
  }
